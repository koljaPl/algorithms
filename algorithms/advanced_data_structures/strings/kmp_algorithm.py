...
# Intuition / Idea:
# Если ты дошёл до несовпадения ты не начинаешь с нуля как в обычном линейном поиске по строкам, ты говоришь:
...
# Почему это быстро?
# Каждый символ текста обрабатывается максимум 1-2 раза
